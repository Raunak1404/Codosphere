          ...
          <div className="container-custom">
            ...
            >
              <div className="flex items-center mb-8">
                ...
                <h1 className="text-3xl font-bold font-display tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-[var(--text)] to-[var(--text-secondary)]">Contact Us</h1>
              </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="lg:col-span-1 space-y-6">
                  <div className="card-interactive">
                    <h2 className="text-xl font-bold font-display mb-6">Get in Touch</h2>
                  ...
                  <div className="card-interactive">
                    <h2 className="text-xl font-bold font-display mb-4">Connect With Us</h2>
