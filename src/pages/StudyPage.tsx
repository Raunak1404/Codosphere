          ...
          <div className="container-custom">
            ...
            >
              <div className="flex items-center mb-2">
                ...
                <h1 className="text-3xl font-bold font-display tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-[var(--text)] to-[var(--text-secondary)]">Study Materials</h1>
              </div>
                  ...
                  >
                    ...
                    >
                      <div className="flex items-center mb-4">
                        ...
                        <div className="ml-4">
                          <h2 className="text-xl font-bold font-display">{topic.title}</h2>
              ...
              <RevealOnScroll direction="up" className="mt-12">
                <h2 className="text-2xl font-bold font-display mb-6">Learning Paths</h2>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  {[
                    ...
                    <div key={index} className="card-interactive">
                      <h3 className="text-xl font-bold font-display mb-2">{path.title}</h3>
              ...
              {/* Resource Center */}
              <RevealOnScroll direction="up" className="mt-12 mb-8">
                <h2 className="text-2xl font-bold font-display mb-6">Resource Center</h2>
