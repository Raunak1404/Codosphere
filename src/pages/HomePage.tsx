      ...
      <div className="flex flex-col min-h-screen">
        ...
        <header className="bg-[var(--primary)] relative min-h-screen flex items-center">
          ...
          <div className="absolute inset-0 overflow-hidden">
            {/* Reduced and simplified background blobs - no animation */}
            <div className="absolute top-1/4 left-1/4 w-[400px] h-[400px] rounded-full bg-[var(--accent)] filter blur-[120px] opacity-5" />
            <div className="absolute bottom-1/4 right-1/4 w-[300px] h-[300px] rounded-full bg-[var(--accent-secondary)] filter blur-[100px] opacity-5" />
          </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              >
                <h1 className="text-4xl md:text-6xl font-bold mb-6">
                  Elevate Your <span className="text-[var(--accent)]">Coding Skills</span>
                </h1>
        ...
        <section ref={featuresRef} className="py-24 bg-[var(--secondary)]">
          <div className="container-custom">
            <div className="text-center mb-16">
              ...
              >
                Features That <span className="text-[var(--accent)]">Set Us Apart</span>
              </motion.h2>
              <motion.p
                initial={{ opacity: 0, y: 20 }}
                whileInView={{ opacity: 1, y: 0 }}
