                    ...
                    <AnimatePresence mode="wait">
                      {!isBoxOpened ? (
                        ...
                        >
                          ...
                          <h2 className="text-2xl font-bold mb-4">Today's Coding Challenge</h2>
                        ...
                        >
                          ...
                          <h2 className="text-2xl font-bold mb-2">Daily Reward Unlocked!</h2>
        ...
        {isBoxOpened && rewardCollected && (
          ...
          >
            ...
            >
              ...
              <h2 className="text-2xl font-bold mb-2 relative z-10">Reward Collected!</h2>
