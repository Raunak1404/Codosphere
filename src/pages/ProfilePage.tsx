...
import { getUserProfile, updateUserProfile, uploadProfileImage } from '../firebase/firebase';
                ...
                <div className="lg:col-span-3 space-y-6">
                  ...
                  >
                    ...
                    {editing ? (
                      ...
                      <>
                        <h2 className="text-2xl font-bold mb-1">{profileData.name || 'Anonymous Coder'}</h2>
                  ...
                  >
                    <div className="flex items-center mb-4">
                      ...
                      <h3 className="text-lg font-semibold">Showcased Achievements</h3>
                    </div>
